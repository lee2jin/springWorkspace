...
public class EmpController {
	...
	//GET  : 조회, 페이지 호출(보안과 관련X, 특히 페이지호출은 POST안됨)
	//POST : 등록, 수정, 삭제(데이터 조작 관련으로 많이 사용)
	...
	//수정(페이지 없이 처리) - Process > Ajax : @ResponseBody
	...
	@ResponseBody
	public Map<String, Object> empUpdateAjaxProsecc(@RequestBody
			EmpVO empVO){
		return empService.updateEmpInfo(empVO);
	}
